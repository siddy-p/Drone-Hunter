...
3. Build the container:
    ...
    ```
    $ docker build -t custom-block-681339 .
    ```
...
4. Train your model:
    ...
    **macOS, Linux**
    ...
    ```
    $ docker run --rm -v $PWD:/scripts custom-block-681339 --data-directory data --out-directory out
    ```

    **Windows**

    ```
    $ docker run --rm -v "%cd%":/scripts custom-block-681339 --data-directory data --out-directory out
    ```
